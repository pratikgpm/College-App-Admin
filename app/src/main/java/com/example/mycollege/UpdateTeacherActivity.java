...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private  String uniqueKey , catagory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTeacherImg = findViewById(R.id.updateTeacherImage);
    ...
    private void deleteData() {
        ...
        reference.child(catagory).child(uniqueKey).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
