...
public class upload_image extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectImage = findViewById(R.id.add_galleryImage);
        imageCategory = findViewById(R.id.image_category);
        uploadImage = findViewById(R.id.upload_notice_button);
        galleryImageView = findViewById(R.id.galleryImageView);
        pd = new ProgressDialog(this);

        String[] items = new String[]{"Select Category","Convocation","Freshers Party","Annual Day","Holi","Diwali","Eid","Traditional Day"};
        ...
        uploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (category.equals("elect Category")) {
                    Toast.makeText(upload_image.this, "Please Select Category", Toast.LENGTH_SHORT).show();
